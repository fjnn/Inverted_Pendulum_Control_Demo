...
from observers import ExtendedKalmanFilter
...
A_nonlinear = A ## TODO with sympy, use sym.sin(theta) and sym.cos(theta)
...
ekf = ExtendedKalmanFilter(A_nonlinear, B_discrete_k, C_discrete_k, Q_kalman, R_kalman)
