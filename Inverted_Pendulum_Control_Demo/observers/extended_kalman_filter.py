...
class ExtendedKalmanFilter:
    ...
    def update(self, control_force, state):
        ...
        ## Linearize here for EKF.
        # theta_num = state[3]
        # sin_theta_num = theta_num - (theta_num^3)/3!
        # cos_theta_num = 1 - (theta_num^2)/2!
        # self.F = self.F.subs({sin_theta:sin_theta_num, cos_theta:cos_theta_num})
        # Now you can proceed as linear Kalman filter.
